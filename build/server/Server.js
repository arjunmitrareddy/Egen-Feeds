...
var Server = (function () {
    ...
    _createClass(Server, [{
        ...
        value: function _serveStaticFiles() {
            ...
            this._app.use('/sw.js', _express2['default']['static']('../public/sw.js', { maxAge: 0 }));
            this._app.use('/manifest.json', _express2['default']['static']('../public/manifest.json', { maxAge: 0 }));
            this._app.use('/imgs', _express2['default']['static']('../public/imgs', { maxAge: 0 }));
            this._app.use('/json', _express2['default']['static']('../public/json', { maxAge: 0 }));
        ...
        value: function _listen() {
            ...
            if (!this._appServerUp) {
                this._appServer.listen(process.env.PORT || this._port, "0.0.0.0", function (_) {
